...
export  const  UserAPI = {
    MoreUsers:(page:number)=>{return instance.get(`users?page=${page}&count=20`).then((response) => response.data)},
    GetUsers:()=>{return instance.get('users?page=1&count=20').then((response) =>  response.data)},
